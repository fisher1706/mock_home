...
for i in range(100):
    ...
    product_row = [SKU, SKU, None, SKU, None, SKU, None, None, None, None, None, None, SKU, SKU, 1, None, None, None,
                   None, None, None, None, None, None, None, None, None, None, None, None]
    location_row = [SKU, SKU, SKU, SKU, None, None, None, None, SKU, 10, 20,
                    "LABEL", SKU+"_cust", None, "Customer", "off", 1]
